...
/**
 * @ORM\Entity(repositoryClass="App\Repository\GenusScientistRepository")
...
class GenusScientist
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Genus", inversedBy="genusScientists")
     * @ORM\JoinColumn(nullable=false)
     */
    private $genus;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="studiedGenuses")
     * @ORM\JoinColumn(nullable=false)
     */
    private $user;
